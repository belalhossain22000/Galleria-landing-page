    ...
    <section className="banner-bg relative z-10 pt-[160px] pb-[100px]">
        ...
        <div className="container">
            <div className="grid xl:grid-cols-[7fr_5fr] md:grid-cols-2 block gap-4 items-center">
                <div className="relative p-[30px] md:order-2 w-[300px] sm:w-[50%] md:w-[100%] mb-[20px] md:mb-0" data-aos='zoom-in' data-aos-delay="300">
                ...
                <div className="banner-content xl:pr-8 pr-0 md:order-1" data-aos='zoom-in'>
