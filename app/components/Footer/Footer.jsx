                    ...
                    <form action="#">
                        <div className="mx-auto relative">
                            ...
                            <motion.button variants={buttonVariants}
                                whileHover="hover"
                                whileTap="tap" className="primary-btn relative sm:absolute xl:right-[12px] xl:top-[12px] w-full sm:w-auto sm:right-[7px] top-[7px] !pt-[14px] !pb-[14px] text-white" type="submit">Submit</motion.button>
                        </div>
                    </form>
